...
void issue_book(){
    ...
    while(another=='y'){
            ...
            while((fread(&issue,sizeof(issue),1,fp))==1){
                 ...
                 printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&");
                 gotoxy(20,9);
                 printf("& ID:%d",issue.id);gotoxy(60,9);printf("&");
                 gotoxy(20,10);
                 printf("\xB2 Name:%s",issue.name);gotoxy(60,10);printf("\xB2");
                 gotoxy(20,11);
                 printf("\xB2 Author:%s ",issue.Author);gotoxy(60,11);printf("\xB2");
                 gotoxy(20,12);
                 printf("\xB2 Price:%.2f",issue.Price);gotoxy(60,12);printf("\xB2");
                 gotoxy(20,13);
                 printf("\xB2 Rack No:%d ",issue.rack_no);gotoxy(60,13);printf("\xB2");
                 gotoxy(20,14);
                 printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&");
                 gotoxy(10,15);
        ...
        while(another=='y')
        {
            ...
            while(fread(&issue,sizeof(issue),1,fs)==1)
            {
                ...
                if(issue.st_id==t)
                {
                 ...
                 printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&");
                 gotoxy(20,9);
                 printf("& Book ID: %d",issue.id);gotoxy(60,9);printf("&");
                 gotoxy(20,10);
                 printf("\xB2 Book Name: %s",issue.name);gotoxy(60,10);printf("\xB2");
                 gotoxy(20,11);
                 printf("\xB2 Author name: %s ",issue.Author);gotoxy(60,11);printf("\xB2");
                 gotoxy(20,12);
                 printf("\xb2 Student Name: %s",issue.st_name);gotoxy(60,12);printf("\xB2");
                 gotoxy(20,13);
                 printf("\xd2 Issued Date: %d-%d-%d",issue.issued.dd,issue.issued.mm,issue.issued.yy);gotoxy(60,13);printf("\xB2");
                 gotoxy(20,14);
                 printf("\xb2 Due Date: %d-%d-%d",issue.due_date.dd,issue.due_date.mm,issue.due_date.yy);gotoxy(60,14);printf("\xB2");
                 gotoxy(20,15);
                 printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&");
                 char dest[50];
                 time_t t;
                    ...
                    if(getch()=='y')
                    {
                        ...
                        while(fread(&issue,sizeof(issue),1,f3)==1)
                        {
                            ...
                            fwrite(&issue,sizeof(issue),1,f1);
                                ...
                                fwrite(&issue,sizeof(issue),1,f2);
                                s=1;
                            }
                        }
                        fclose(fp);
